...
usuarios_db = [
    ...
    {'id': 2, 'nome': 'Nicholas Duarte', 'cargo': 'Design', 'ativo': True},
    {'id': 3, 'nome': 'Josué Calebe', 'cargo': 'QA', 'ativo': False},
    {'id': 4, 'nome': 'Davi Willian', 'cargo': 'Mecânica Automotiva', 'ativo': True},
]
