...
banco: list[UsuarioSaida] = [
    UsuarioSaida(id=1, nome='Tony Stark', email='iamironman@email.com', 
                 cargo='Mecânico', ativo=False, salario=30000000.0),
    UsuarioSaida(id=2, nome='Davi Willian', email='davidwillian@email.com', 
                 cargo='Engenheiro Mecânico', ativo=True, salario=7500.0),
    UsuarioSaida(id=3, nome='Peter Parker', email='spidermneighborhood@email.com', 
                 cargo='Mecânico', ativo=True, salario=3000.0),
]
proximo_id = 4
